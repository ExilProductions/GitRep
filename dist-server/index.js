...
import { createSession, getSession, getGitHubClientId, getGitHubClientSecret } from './auth.js'
...
const repoSubscribers = new Map()
function broadcastRepUpdate(owner, repo, reputation) {
...
async function authGithubHandler(request, reply) {
